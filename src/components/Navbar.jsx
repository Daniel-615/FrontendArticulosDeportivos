                ...
                <>
                  <li className="flex-shrink-0">
                    <NavLink
                      to="/login"
                      className={({ isActive }) =>
                        `px-3 py-2 text-white/80 hover:text-white hover:bg-white/5 transition-colors text-xs sm:text-sm font-medium tracking-wide whitespace-nowrap ${
                  ...
                  <li className="flex-shrink-0">
                    <NavLink
                      to="/register"
                      className={({ isActive }) =>
                        `px-3 py-2 bg-white text-black hover:bg-white/90 transition-colors text-xs sm:text-sm font-bold tracking-wide whitespace-nowrap ${
